...
smd({
  ...
  try {
    ...
    return await _0x21be87.bot.sendMessage(_0x21be87.chat, {
      image: {
        url: await aiResponce(_0x21be87, "mdalle", _0x17d498)
      },
      caption: "*---Your DALL-E Result---*\n" + Config.caption
    });
  } catch (_0x25b4b9) {
    await _0x21be87.error(_0x25b4b9 + "\n\ncommand: mdalle", _0x25b4b9, "*_No responce from Dall-E Ai, Sorry!!_*");
  }
});
smd({
  pattern: "imagine",
  ...
  try {
    ...
    return await _0x9bac01.bot.sendMessage(_0x9bac01.chat, {
      image: {
        url: await aiResponce(_0x9bac01, "mdalle", _0x2968fd)
      },
      caption: "*---Your DALL-E Result---*\n" + Config.caption
    });
  } catch (_0x5d8080) {
